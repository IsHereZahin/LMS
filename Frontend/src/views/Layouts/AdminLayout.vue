  ...
  <div class="g-sidenav-show" :class="sidebarClass">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
      ...
      <div class="sidenav-header">
        ...
        <router-link to="/admin-dashboard" class="navbar-brand m-0 d-flex align-items-center">
      ...
      <div class="navbar-collapse w-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link class="nav-link" :class="{ active: $route.path === '/admin-dashboard/courses' }" to="/admin-dashboard/courses">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div class="sidenav-footer mx-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
          <div class="full-background"
            style="background-image: url('../../assets/admin/img/curved-images/white-curved.jpeg');">
          </div>
...
export default {
  ...
  computed: {
    sidebarClass() {
      return this.sidebarOpen ? 'g-sidenav-pinned' : 'g-sidenav-hidden';
    }
  },
  mounted() {
  ...
  beforeUnmount() {
    ...
    const closeBtn = document.getElementById('iconSidenav');
    if (closeBtn) {
      closeBtn.removeEventListener('click', this.toggleSidebar);
    }
  },
  methods: {
    toggleSidebar() {
    ...
    updateSidenavStyles() {
      ...
      if (sidenav && window.innerWidth < 1200) {
        sidenav.classList.toggle("bg-white", this.sidebarOpen);
        sidenav.classList.toggle("bg-transparent", !this.sidebarOpen);
      }
    },
...
<style>
@import url("../../assets/admin/css/nucleo-icons.css");
@import url("../../assets/admin/css/nucleo-svg.css");
@import url("../../assets/admin/css/soft-ui-dashboard.css");
.icon-shape {
  display: flex;
  align-items: center;
...
.sidenav .navbar-nav .nav-link .icon-shape svg,
.navbar-main .navbar-nav .nav-link .icon-shape svg {
