              ...
              <div class="card p-2 shadow h-100">
                <div class="rounded-top overflow-hidden">
                  <div class="card-overlay-hover">
                    <!-- Image -->
                    <img src="../../assets/website/images/courses/4by3/17.jpg" class="card-img-top" alt="course image">
                  </div>
                  <!-- Hover element -->
                  <div class="card-img-overlay">
                ...
                <div class="card-body px-2">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="avatar avatar-sm">
                      <img class="avatar-img rounded-circle" src="../../assets/website/images/avatar/09.jpg" alt="avatar">
                    </div>
                  </div>
                  <!-- Divider -->
                  <hr>
            ...
            <div class="col-md-6 col-lg-4 col-xxl-3">
              <div class="card p-2 shadow h-100">
                <div class="rounded-top overflow-hidden">
                  <div class="card-overlay-hover">
                    <!-- Image -->
                    <img src="../../assets/website/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
                  </div>
                  <!-- Hover element -->
                  <div class="card-img-overlay">
                    <div class="card-element-hover d-flex justify-content-end">
                ...
                <div class="card-body px-2">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <!-- Avatar -->
                    <div class="avatar avatar-sm">
                      <img class="avatar-img rounded-circle" src="../../assets/website/images/avatar/12.jpg" alt="avatar">
                    </div>
                  </div>
                  <!-- Divider -->
                  <hr>
            ...
            <div class="col-md-6 col-lg-4 col-xxl-3">
              <div class="card p-2 shadow h-100">
                <div class="rounded-top overflow-hidden">
                  <div class="card-overlay-hover">
                    <!-- Image -->
                    <img src="../../assets/website/images/courses/4by3/19.jpg" class="card-img-top" alt="course image">
                  </div>
                  <!-- Hover element -->
                  <div class="card-img-overlay">
                    <div class="card-element-hover d-flex justify-content-end">
                ...
                <div class="card-body px-2">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <!-- Avatar -->
                    <div class="avatar avatar-sm">
                      <img class="avatar-img rounded-circle" src="../../assets/website/images/avatar/08.jpg" alt="avatar">
                    </div>
                  </div>
                  <!-- Divider -->
                  <hr>
